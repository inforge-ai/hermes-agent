...
_EXTRA_ENV_KEYS = frozenset({
    ...
    "ZULIP_HOME_STREAM", "ZULIP_HOME_TOPIC", "ZULIP_HOME_CHANNEL_NAME",
...
OPTIONAL_ENV_VARS = {
    ...
    "ZULIP_SITE": {
        ...
        "url": "https://zulip.com/help/install-your-own-server",
        "password": False,
        "category": "messaging",
    },
    "ZULIP_EMAIL": {
    ...
    "ZULIP_ALLOWED_USERS": {
        "description": "Comma-separated Zulip user IDs allowed to use the bot",
        "prompt": "Allowed Zulip user IDs (comma-separated)",
        "url": None,
        "password": False,
        "category": "messaging",
    },
    "ZULIP_REQUIRE_MENTION": {
        "description": "Require @mention in Zulip streams (default: true). Set to false to respond to all messages in subscribed streams.",
        "prompt": "Require @mention in streams",
        "url": None,
        "password": False,
        "category": "messaging",
    },
    "ZULIP_FREE_RESPONSE_STREAMS": {
        "description": "Comma-separated Zulip stream IDs where bot responds without @mention",
        "prompt": "Free-response stream IDs (comma-separated)",
        "url": None,
        "password": False,
        "category": "messaging",
    },
